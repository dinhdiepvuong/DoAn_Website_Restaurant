...
const schema = yup.object({
    ...
    productTypeId: yup.string().required("Loại món ăn không được trống"),
});
    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="font25 d-flex justify-content-center font_family_bold mt-2">Thêm món ăn mới</div>
