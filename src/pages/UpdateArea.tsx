    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="font25 d-flex justify-content-center font_family_bold mt-2">Cập nhật thông tin khu vực</div>
            ...
            <ModalListObject handleFilter={(e: any) => setName(e)} onChangePage={(e: any) => setPage(e)} page={page} handleClose={handleCloseModal} chosenData={chosenArea} data={dataModal} header={header} onChoose={handleChoose} />
        </>
    )
}
